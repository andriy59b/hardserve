...
class Command(BaseCommand):
    ...
    # #Раціон 4
    # recipe1 = Recipe.objects.get(id=) # breakfast 4
    # recipe2 = Recipe.objects.get(id=) # breakfast 4
    # recipe3 = Recipe.objects.get(id=) # breakfast 4

    # recipe4 = Recipe.objects.get(id=) # lunch 4
    # recipe5 = Recipe.objects.get(id=) # lunch 4
    # recipe6 = Recipe.objects.get(id=) # lunch 4

    # recipe7 = Recipe.objects.get(id=) # snack 4
    # recipe8 = Recipe.objects.get(id=) # snack 4
    # recipe9 = Recipe.objects.get(id=) # snack 4

    # recipe10 = Recipe.objects.get(id=) # dinner 4 
    # recipe11 = Recipe.objects.get(id=) # dinner 4
    # recipe12 = Recipe.objects.get(id=) # dinner 4
    ...
    # #Раціон 5
    # recipe1 = Recipe.objects.get(id=) # breakfast 5
    # recipe2 = Recipe.objects.get(id=) # breakfast 5
    # recipe3 = Recipe.objects.get(id=) # breakfast 5

    # recipe4 = Recipe.objects.get(id=) # lunch 5
    # recipe5 = Recipe.objects.get(id=) # lunch 5
    # recipe6 = Recipe.objects.get(id=) # lunch 5

    # recipe7 = Recipe.objects.get(id=) # snack 5
    # recipe8 = Recipe.objects.get(id=) # snack 5
    # recipe9 = Recipe.objects.get(id=) # snack 5

    # recipe10 = Recipe.objects.get(id=) # dinner 5 
    # recipe11 = Recipe.objects.get(id=) # dinner 5
    # recipe12 = Recipe.objects.get(id=) # dinner 5
