  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center w-10/12 mx-auto text-center">
        <h1 className="p-2 mt-10 mb-5 text-5xl font-bold text-transparent h-fit w-fit bg-clip-text bg-gradient-to-br from-green-500 to-indigo-500">
          About The Project
        </h1>
        <p className="text-2xl">
          ...
          for{" "}
          <b className="text-transparent bg-gradient-to-r from-cyan-500 to-indigo-500 bg-clip-text">
        ...
        <h1 className="p-2 mt-10 mb-5 text-5xl font-bold text-transparent h-fit w-fit bg-clip-text bg-gradient-to-br from-sky-500 to-green-500">
          About Our Team
        </h1>
        <div className="flex flex-wrap justify-center gap-4 mb-10 ">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="flex flex-col items-center p-4 bg-white shadow-md w-60 rounded-xl"
            >
              <img
                src={member.img}
                alt={member.name}
              ...
              />
              <h2 className="mt-2 text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-500 to-sky-500">
                {member.name}
              </h2>
