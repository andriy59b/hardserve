        ...
        <div className="relative flex flex-col items-center p-4 rounded-xl">
            ...
            <div className="p-2 macros">
                ...
                <div className="flex justify-center gap-2 pt-2">
                    <p className="inline-flex items-center px-2 py-1 text-xs font-medium text-gray-600 bg-gray-100 rounded-md ring-1 ring-inset ring-gray-100">Fiber: {ingredient.fiber}g</p>
