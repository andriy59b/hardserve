...
function IngredientCard({ingredient, darkMode}){
    return (
        <div className={`relative flex flex-col items-center px-2 py-4 bg-transparent ${darkMode ? 'bg-gray-200 dark:bg-gray-900' : 'bg-gray-200'} shadow-lg cursor-pointer w-72 rounded-xl`} onClick={() => window.location.href += "/" + ingredient.product_id}>
